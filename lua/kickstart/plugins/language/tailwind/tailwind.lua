...
return {
	...
	keys = {
		...
		-- Class sorting
		{ "<leader>cts", function() vim.cmd.TailwindSortSync() end,          desc = "Sort Tailwind classes",   ft = tw_ft },
		{ "<leader>cts", function() vim.cmd.TailwindSortSelectionSync() end, desc = "Sort Tailwind classes",   ft = tw_ft, mode = 'v' },
		-- Class navigation
